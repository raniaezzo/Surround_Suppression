...
shaderPath = fullfile(currentFolder, 'BasicPerlinScaledNoiseShader');
%noiseShader = LoadGLSLProgramFromFiles(shaderPath, 1);
noiseShader = LoadGLSLProgramFromFiles({'PerlinNoiseLib.frag.txt', [shaderPath,'.vert.txt'], [shaderPath,'.frag.txt']}, debuglevel);
...
%     % Load standard 2D Perlin noise shader:
%     noiseShader = LoadGLSLProgramFromFiles({'ClassicPerlinNoiseLib.frag.txt', 'BasicPerlinScaledNoiseShader.vert.txt', 'BasicPerlinScaledNoiseShader.frag.txt'}, debuglevel);
% end
